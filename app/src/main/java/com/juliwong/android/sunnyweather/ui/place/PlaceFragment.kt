...
import com.juliwong.android.sunnyweather.MainActivity
...
class PlaceFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        // 如果是MainActivity，且保存了Place，直接跳转到WeatherActivity
        ...
        viewModel.placeLivaData.observe(this, Observer { result ->
